...
//		}
	...
	public void remove(Visible v){
		/**ArrayList notes
		 * While this method is very simple, do not underestimate the trickiness of removing items in an 
		 * ArrayList. It causes indices to change:
		 * Ex. Suppose you have an ArrayList<Interger> and you want to remove all values greater than 5.
		 * 
		 * This is BAD:
		 ...
		 * the first Integer to be removed is 6, at index 2 since it gets removed, 7 moves from 3 to 2.
