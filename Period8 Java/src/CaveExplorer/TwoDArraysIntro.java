...
public class TwoDArraysIntro {
	...
	private static void startExploring() {
		...
		System.out.println("Congratulations! You found the tresure!");
	}
	...
	private static int[] interpretInput(String input) {
		...
		if(currenti >= 0 && currenti <arr2D.length && currentj >= 0 && currentj <arr2D[0].length){
			...
			System.out.println("Sorry, you've reach the edge of the known universe. You may go no "
	...
	//ways check to see if ArrayIndexOutOfBoundsException
...
//			for(int c = 0; r <mines[r].length; c++){
